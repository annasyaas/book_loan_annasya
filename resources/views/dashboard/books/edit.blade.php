...
@section('container')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Form Edit Buku</h1>
    </div>
    <div class="col-lg-8">
        <form method="post" action="/dashboard/buku/{{ $buku->slug }}" class="mb-5">
            @method('PUT')
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input id="desc" type="hidden" name="desc" value="{{ old('desc', $buku->desc) }}">
                <trix-editor input="desc"></trix-editor>
                @error('desc')
                    <p class="text-danger">{{ $message }}</p>
                @enderror
            </div>
            <a href="/dashboard/buku" class="btn btn-success text-decoration-none">
